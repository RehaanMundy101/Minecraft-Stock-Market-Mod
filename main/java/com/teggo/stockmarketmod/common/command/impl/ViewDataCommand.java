...
import com.teggo.stockmarketmod.core.procedures.ViewDataCommandExecutedProcedure;
...
public class ViewDataCommand {
	@SubscribeEvent
	public static void registerCommand(RegisterCommandsEvent event) {
		event.getDispatcher().register(Commands.literal("viewdata")
	...
	private static int execute(CommandContext<CommandSourceStack> ctx) throws IOException {
		...
		ViewDataCommandExecutedProcedure.execute(entity, cmdparams);
		return 0;
	}
}
