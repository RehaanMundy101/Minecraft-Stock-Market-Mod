...
import com.teggo.stockmarketmod.core.procedures.BuyStockCommandExecutedProcedure;
...
public class BuyStockCommand {
	...
	public static void registerCommand(RegisterCommandsEvent event) {
		event.getDispatcher().register(Commands.literal("buystock")
	...
	private static int execute(CommandContext<CommandSourceStack> ctx) throws IOException {
		...
		BuyStockCommandExecutedProcedure.execute(world, entity, cmdparams);
		return 0;
	}
}
